       ...
       <form action="{{route('books.update' , $book)}}" method="post" enctype="multipart/form-data">
        ...
        @method('put')
            <div class="mb-6">
                ...
                <input type="text" name="titulo"value="{{ old('titulo' , $book -> titulo) }}" id="titulo" placeholder="Titulo del libro" class=" mb-4 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                @error('titulo')
                    <x-inputerror>
                        {{$message}}
                    </x-inputerror>
                ...
                <div class="mb-6">
                    <label for="precioArticulo" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        Sinopsis</label>
                    <textarea id="sinpsis" type="text" id="sinpsis" step="0.01" name="sinopsis" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Sinopsis del libro" rows="10" >{{old('sinopsis' , $book -> sinopsis)}}</textarea>
                 @error('sinopsis')
                     <x-inputerror>
                        {{$message}}
                    </x-inputerror>
                ...
                <div class="mb-6">
                    <label for="precioArticulo" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                       Precio</label>
                    <input id="precioArticulo" value="{{old('precio' , $book -> precio)}}" type="number" id="precio" step="0.01" name="precio" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Precio" >
                  @error('precio')
                      <x-inputerror>
                        {{$message}}
                      </x-inputerror>
                ...
                <div class="mb-6">
                    <label for="precioArticulo" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                    Stock</label>
                    <input id="precioArticulo" value="{{old('stock' , $book -> stock)}}" type="number" id="stock" step="0.01" name="stock" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="stock" >
                  @error('stock')
                      <x-inputerror>
                        {{$message}}
                      </x-inputerror>
                ...
                <div class="mb-6">
                    ...
                    <input id="estado" value="PUBLICADO" @checked(old('estado' , $book -> estado) == "PUBLICADO") type="checkbox"  id="stock" step="0.01" name="estado" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" >
                  @error('estado')
                      <x-inputerror>
                        {{$message}}
                      </x-inputerror>
                ...
                <div class="mb-6">
                    ...
                    <select class="bg-gray-50 border mt-2 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="author_id" id="autor">
                        ...
                        @foreach ($autor as $item)
                            <option value="{{$item -> id}}" @selected(old('author_id' , $book -> author_id) == $item -> id)>{{$item -> nombre}}</option>
                        @endforeach
                    </select>
                    @error('author_id')
                    <x-inputerror>
                    ...
                    <div class="flex w-full">
                        <div class="w-1/2 mr-2">
                            <label for="imagen"  class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                Imagen</label>
                            <input type="file" value="{{old('imagen' , $book -> imagen)}}" id="imagen" oninput="img.src=window.URL.createObjectURL(this.files[0])"
                        ...
                        @enderror
                        <div class="w-1/2">
                            <img src="{{Storage::url($book -> imagen)}}"
